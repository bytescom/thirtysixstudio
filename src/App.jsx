...
const App = () => {
  ...
  return (
    <>
      <div className='relative h-full w-full bg-[#fffafa]  select'>
        {showCanvas && data[0].map((candetails, index) => (
        ...
        <div className='relative flex justify-center align-baseline h-[530px] pt-14'>
          ...
          <div className='w-[13%] mt-[5rem] ml-[9rem] select-none'>
            <img ref={rotateImg} src="rotatecircle.png" alt="loading..." />
          </div>
        </div>
      ...
      <div className='h-full w-full bg-[#fffafa] select'>
        ...
        <div className='flex flex-col gap-[6rem] w-[25%] ml-[56%] tracking-tight leading-tight pt-[8rem] pb-[15rem]'>
          ...
          <div className='flex flex-col gap-[4rem]'>
            ...
            <button className='text-left'>
              <span className='text-sm underline border-[1px] border-[#ebe5e5] rounded-[25px] px-[35px] py-[10px]'>LEARN MORE</span>
            </button>
          </div>
        </div>
        <Divider />
      ...
      <div className='h-full w-full bg-[#fffafa] select'>
        <div className='flex flex-col gap-[4rem] max-w-[55%] ml-[26%] leading-tight tracking-tighter py-[5rem]'>
          ...
          <div className='flex flex-col gap-[3rem] text-[2rem]'>
            ...
            <p>Through SS36, we reinvest some of our revenue and expertise into the communities that shape the culture and trends our field so heavily relies on. Our main focus is on bridging gaps for those affected by systemic obstacles related to race, sexuality, wealth, and gender identity.</p>
          </div>
        </div>
        <Divider />
        <div className='flex flex-col gap-[2rem] max-w-[25%] ml-[26%] leading-tight tracking-tight pt-[5rem] pb-[10rem]'>
          ...
          <button className='text-left'>
            <span className='text-sm underline border-[1px] border-black rounded-[25px] px-[25px] py-[6px]'>GET IN TOUCH</span>
          </button>
        </div>
        <Divider />
      </div>
        ...
        <div className='flex justify-center tracking-tight leading-tight pt-[5rem] pb-[10rem]'>
          ...
          <div className='flex flex-col gap-[3rem] w-[25%] ml-[16rem]'>
            ...
            <div className='flex flex-col gap-[3rem] mt-[5rem]'>
              ...
              <button className='text-left'>
                <span className='text-sm underline border-[1px] border-[#ebe5e5] rounded-[25px] px-[35px] py-[10px]'>
                  DROP US A LINE
                </span>
              </button>
            </div>
      ...
      <div className='h-full w-full bg-[#fffafa] select'>
        ...
        <div className='flex flex-col gap-[2rem] max-w-[24%] ml-[26%] leading-tight tracking-tight py-[5rem]'>
          <div className='flex flex-col gap-[3rem]'>
            ...
            <button className='text-left'>
              <span className='text-sm underline bg-[#fd2c2a] border-[1px] border-#ebe5e5 rounded-[25px] px-[35px] py-[10px]'>BRING THE HEAT!</span>
            </button>
          </div>
        </div>
        <Divider />
      ...
      <div className='w-full h-full bg-[#fffafa] select'>
        <div className='flex justify-center tracking-tight leading-tight py-[5rem]'>
          ...
          <div className='flex flex-col mr-[3rem] gap-[5rem]'>
            ...
            <div className='flex'>
              <button className='text-left'>
                <span className='text-sm underline border-[1px] border-[#ebe5e5] rounded-[25px] px-[35px] py-[10px]'>PRIVACY STATEMENT</span>
              </button>
            </div>
          </div>
        </div>
        {/* make this half alphabet effect */}
        {/* <div className='text-[15vw] text-center'>
          Thirtysixstudio
        </div> */}
      </div>
