...
const App = () => {
  ...
  return (
    <>
      <div className={` ${!isBgChange ? 'bg-[#fffafa] dark:bg-black dark:text-white' : 'bg-[#fd2c2a] dark:text-black'} `}>

        <Message isBgChange={isBgChange} isVisible={isMessageVisible} setIsVisible={setIsMessageVisible}/>
        <div className={`relative h-full w-full select `}>
          ...
          <div className='relative flex justify-center align-baseline h-[530px] pt-14 mt-[3.3rem]'>
        ...
        <div className={`relative h-full w-full select`}>
          ...
          <div>
            ...
            <OpenRole isBgChange={isBgChange} />
            <Divider isBgChange={isBgChange} />
        ...
        <div className={`relative h-[475px] w-full select    `}>
